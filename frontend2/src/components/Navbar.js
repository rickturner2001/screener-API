            ...
            <nav className="navbar bg-base-300">
                ...
                <div className="navbar-end mr-4">
                        <>
                            ...
                            {!user ?   (
                                <>
                                <label htmlFor="login-modal" className="btn modal-button btn-accent btn-sm">Log in</label>
                                <label htmlFor="SignupModal" className="btn modal-button btn-ghost btn-sm ml-4">SignUp</label>
                                </>
                                    ) : <button className="btn modal-button btn-accent btn-sm" onClick={logoutUser}>Log out</button>}
